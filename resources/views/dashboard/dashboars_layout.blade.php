    ...
    @if(session('role') == 'doctor')
      ...
      >
        <div class="py-4 text-gray-500 dark:text-gray-400">
            ...
            <li class="relative px-6 py-3">
              ...
              <template x-if="isPagesMenuOpen">
                ...
                >
                  ...
                  >
                    <a class="w-full" href="{{ route('login') }}">Se Connecter</a>
                  </li>
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
          ...
          <div class="px-6 my-6">
            <button
              class="flex items-center justify-between w-full px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-300 focus:outline-none focus:shadow-outline-blue"
            >
              Create account
      ...
      >
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          <div class="px-6 my-6">
            <button
              class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-300 focus:outline-none focus:shadow-outline-blue"
            >
              Creer Un Compte
              <span class="ml-2" aria-hidden="true">+</span>
            </button>
            ...
            <div class="flex justify-center flex-1 lg:mr-32">
              ...
              >
                ...
                <input
                  ...
                  type="text"
                  placeholder="Chercher quelquechose"
                  aria-label="Search"
                />
              </div>
            </div>
...
<div id="profileModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
    <div class="bg-white dark:bg-gray-900 p-5 rounded-lg w-1/3">
        <h2 class="text-xl font-bold text-center mb-4">Mon Profil</h2>
        <form id="profileForm">
            <input type="hidden" id="doctor_id">

            <label class="block mb-2">Biographie</label>
            <textarea id="biography" class="w-full p-2 border rounded"></textarea>

            <label class="block mt-3 mb-2">Niveau d'Éducation</label>
            <input type="text" id="education_level" class="w-full p-2 border rounded">

            <label class="block mt-3 mb-2">Spécialité</label>
            <select id="specialty_id" class="w-full p-2 border rounded"></select>

            <div class="flex justify-end mt-4">
                <button type="button" id="closeModal" class="bg-gray-500 text-white px-4 py-2 rounded mr-2">Fermer</button>
